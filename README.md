# 🏛️ Roma Antiga: Uma Jornada Interativa
...
- **JavaScript Moderno:** Manipulação de DOM para exibição dinâmica de conteúdo baseado em eventos de clique.

## 🌟 Funcionalidades
- Navegação fluida entre seções.
- Pirâmide social interativa que altera o conteúdo explicativo sem recarregar a página.
- Galeria de personagens históricos com tratamento de imagens via CSS.
